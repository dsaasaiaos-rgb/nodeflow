...
export default function MasterHubDashboard() {
  ...
  const NodeModal = ({ children }) => (
    <div className="fixed inset-0 z-50">
      ...
      <div className="absolute inset-x-0 bottom-0 max-h-[92vh] overflow-hidden rounded-t-3xl border border-zinc-200 bg-white shadow-2xl md:inset-y-10 md:mx-auto md:max-w-5xl md:rounded-3xl dark:border-zinc-800 dark:bg-zinc-950">
      ...
      <div className="mx-auto max-w-6xl px-4 py-8">
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          ...
          <div className="flex items-center gap-3">
            <div className="rounded-2xl border border-zinc-200 bg-white px-3 py-2 text-sm shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
              <div className="text-[11px] font-semibold text-zinc-500 dark:text-zinc-400">Signed in</div>
              <div className="mt-1 flex items-center gap-2">
                <span className="font-medium">{currentUser?.name ?? "Unknown"}</span>
                <span className="rounded-full border border-zinc-200 px-2 py-0.5 text-[11px] text-zinc-600 dark:border-zinc-800 dark:text-zinc-300">
                  {currentUser?.role ?? "—"}
                </span>
              </div>
            </div>
            ...
            <div className="flex flex-col">
              <label className="text-[11px] font-semibold text-zinc-500 dark:text-zinc-400">Switch user</label>
              <select
                value={db.currentUserId}
                onChange={(e) => switchUser(e.target.value)}
                className="mt-1 rounded-xl border border-zinc-200 bg-white px-3 py-2 text-sm shadow-sm outline-none focus:ring-2 focus:ring-zinc-300 dark:border-zinc-800 dark:bg-zinc-950 dark:focus:ring-zinc-700"
              >
                {db.users
        ...
        <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {nodes.map((n) => (
            <button
              ...
              className="group relative overflow-hidden rounded-3xl border border-zinc-200 bg-white p-5 text-left shadow-sm transition hover:-translate-y-0.5 hover:shadow-md dark:border-zinc-800 dark:bg-zinc-950"
            >
              <div className="flex items-start justify-between gap-3">
                <div>
                  <div className="text-xs font-semibold text-zinc-500 dark:text-zinc-400">Node</div>
                ...
                <div className="rounded-2xl border border-zinc-200 bg-zinc-50 px-3 py-2 text-xs text-zinc-600 dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-200">
                  Updated
                  <div className="mt-1 font-semibold">{fmtDateTime(n.updatedAt)}</div>
                </div>
              </div>

              <div className="mt-4 text-sm text-zinc-600 line-clamp-3 dark:text-zinc-300">
                {n.overview.summary}
              </div>
        ...
        {currentUser?.role === "OWNER" && (
          <div className="mt-8 rounded-3xl border border-zinc-200 bg-white p-5 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
            ...
            <div className="mt-4 grid grid-cols-1 gap-3 md:grid-cols-3">
              <div className="rounded-2xl border border-zinc-200 bg-zinc-50 p-3 dark:border-zinc-800 dark:bg-zinc-900">
                <div className="text-xs font-semibold text-zinc-500 dark:text-zinc-400">Assistants</div>
                <div className="mt-2 space-y-2">
                  {assistants.map((a) => (
                    <div key={a.id} className="flex items-center justify-between text-sm">
                      <span className="font-medium">{a.name}</span>
                      <span className="text-xs text-zinc-500 dark:text-zinc-400">{a.email}</span>
                    </div>
                  ))}
                  {assistants.length === 0 && (
                    <div className="text-sm text-zinc-600 dark:text-zinc-300">No assistants found.</div>
                  )}
                </div>
              </div>

              <div className="rounded-2xl border border-zinc-200 bg-zinc-50 p-3 dark:border-zinc-800 dark:bg-zinc-900 md:col-span-2">
                <div className="text-xs font-semibold text-zinc-500 dark:text-zinc-400">Access Map</div>
                <div className="mt-2 space-y-3">
                  {db.nodes.map((n) => (
                    <div key={n.id} className="rounded-2xl border border-zinc-200 bg-white p-3 dark:border-zinc-800 dark:bg-zinc-950">
                      <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                            ...
                            return (
                              <div key={a.id} className="flex items-center gap-2">
                                <select
                                  ...
                                  className="rounded-xl border border-zinc-200 bg-white px-2 py-1 text-xs shadow-sm outline-none focus:ring-2 focus:ring-zinc-300 dark:border-zinc-800 dark:bg-zinc-950 dark:focus:ring-zinc-700"
                                >
        ...
        {selectedNode && draft && (
          <NodeModal>
            ...
            <div className="sticky top-0 z-10 border-b border-zinc-200 bg-white/90 px-4 py-4 backdrop-blur md:px-6 dark:border-zinc-800 dark:bg-zinc-950/90">
              ...
              {activeTab === "OVERVIEW" && (
                <div className="space-y-4">
                  <div className="rounded-3xl border border-zinc-200 bg-white p-4 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
                    <div className="text-xs font-semibold text-zinc-500 dark:text-zinc-400">Project Summary</div>
                    <textarea
                      ...
                      className="mt-2 h-28 w-full resize-none rounded-2xl border border-zinc-200 bg-white p-3 text-sm outline-none focus:ring-2 focus:ring-zinc-300 disabled:opacity-70 dark:border-zinc-800 dark:bg-zinc-950 dark:focus:ring-zinc-700"
                    />
                  </div>

                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <div className="rounded-3xl border border-zinc-200 bg-white p-4 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
                      <div className="text-xs font-semibold text-zinc-500 dark:text-zinc-400">Live Site URL</div>
                      <input
                        ...
                        className="mt-2 w-full rounded-2xl border border-zinc-200 bg-white px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-zinc-300 disabled:opacity-70 dark:border-zinc-800 dark:bg-zinc-950 dark:focus:ring-zinc-700"
                        placeholder="https://…"
                      />
                      {draft.overviewLiveSiteUrl?.trim() ? (
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="mt-2 inline-block text-sm font-semibold text-zinc-900 underline underline-offset-4 dark:text-zinc-100"
                        >
                          Open live site →
                        </a>
                      ) : null}
                    ...
                    <div className="rounded-3xl border border-zinc-200 bg-white p-4 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
                      <div className="text-xs font-semibold text-zinc-500 dark:text-zinc-400">Internal Notes</div>
                      <textarea
                ...
                <div className="space-y-4">
                  <div className="flex flex-wrap items-center justify-between gap-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <select
                        ...
                        className="rounded-xl border border-zinc-200 bg-white px-3 py-2 text-sm shadow-sm outline-none focus:ring-2 focus:ring-zinc-300 disabled:opacity-70 dark:border-zinc-800 dark:bg-zinc-950 dark:focus:ring-zinc-700"
                      >
                  ...
                  <div className="rounded-3xl border border-zinc-200 bg-white p-4 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
                    ...
                    <textarea
                      ...
                      className="mt-2 h-80 w-full resize-none rounded-2xl border border-zinc-200 bg-white p-3 font-mono text-xs outline-none focus:ring-2 focus:ring-zinc-300 disabled:opacity-70 dark:border-zinc-800 dark:bg-zinc-950 dark:focus:ring-zinc-700"
                    />
                  </div>
                </div>
              )}
                ...
                <div className="space-y-4">
                  ...
                  <div className="rounded-3xl border border-zinc-200 bg-white p-4 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
                    <textarea
                      ...
                      className="mt-1 h-[420px] w-full resize-none rounded-2xl border border-zinc-200 bg-white p-3 text-sm outline-none focus:ring-2 focus:ring-zinc-300 disabled:opacity-70 dark:border-zinc-800 dark:bg-zinc-950 dark:focus:ring-zinc-700"
                    />
                    {!editable && (
                      <div className="mt-3 rounded-2xl border border-zinc-200 bg-zinc-50 p-3 text-sm text-zinc-700 dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-200">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    {nodeAgreements.map((a) => (
                      ...
                      >
                        ...
                        <input
                          ...
                          className="mt-3 w-full rounded-2xl border border-zinc-200 bg-white px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-zinc-300 disabled:opacity-70 dark:border-zinc-800 dark:bg-zinc-950 dark:focus:ring-zinc-700"
                    ...
                    {nodeAgreements.length === 0 && (
                      <div className="rounded-3xl border border-dashed border-zinc-300 bg-white p-6 text-sm text-zinc-600 dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-300">
                        No agreements yet.
                      </div>
                    )}
                  </div>
                  ...
                  <div className="space-y-2">
                    {nodeActivity.map((a) => {
                      ...
                      return (
                        <div
                          key={a.id}
                          className="flex flex-col gap-1 rounded-2xl border border-zinc-200 bg-white p-3 text-sm dark:border-zinc-800 dark:bg-zinc-950"
                        >
                          <div className="flex flex-wrap items-center justify-between gap-2">
                            <div className="font-medium">
                              {u?.name ?? a.userId}: <span className="font-semibold">{a.action}</span>
                            </div>
                            <div className="text-xs text-zinc-500 dark:text-zinc-400">{fmtDateTime(a.createdAt)}</div>
                          </div>
                        </div>
                      );
                    })}
            ...
            {/* Footer hint bar */}
            <div className="border-t border-zinc-200 bg-white px-4 py-3 text-xs text-zinc-500 md:px-6 dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-400">
              {editable ? (
                <span>
...
function ChatPanel({
  ...
  return (
    <div className="space-y-4">
      ...
      <div
        ref={listRef}
        className="h-[420px] overflow-y-auto rounded-3xl border border-zinc-200 bg-white p-4 shadow-sm dark:border-zinc-800 dark:bg-zinc-950"
      >
        {messages.length === 0 ? (
          ...
          <div className="space-y-3">
            {messages.map((m) => {
              ...
              return (
                <div key={m.id} className="rounded-2xl border border-zinc-200 bg-zinc-50 p-3 text-sm dark:border-zinc-800 dark:bg-zinc-900">
                  <div className="flex items-center justify-between gap-2">
                    <div className="font-semibold">{u?.name ?? m.userId}</div>
                    <div className="text-xs text-zinc-500 dark:text-zinc-400">{new Date(m.createdAt).toLocaleString()}</div>
                  </div>
                  <div className="mt-2 whitespace-pre-wrap text-zinc-800 dark:text-zinc-100">{m.message}</div>
                </div>
              );
            })}
          </div>
      ...
      <div className="rounded-3xl border border-zinc-200 bg-white p-4 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
        <div className="text-xs font-semibold text-zinc-500 dark:text-zinc-400">New message</div>
        <textarea
          value={msg}
          disabled={!editable}
