            ...
            <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
                ...
                >
                    <div className="text-center">
                        ...
                        <h3 className="text-2xl font-bold text-gray-900 mb-2">Node Created!</h3>
                        <p className="text-gray-600 mb-6">Share this invite code with your team:</p>
                        <div className="bg-gradient-to-br from-indigo-50 to-purple-50 p-6 rounded-xl mb-6 border border-indigo-100">
                            <p className="text-3xl font-mono font-bold text-center text-indigo-600 tracking-wider">{inviteCode}</p>
                        </div>
                        <Button
                            onClick={onClose}
    ...
    return (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
            <motion.div 
                ...
                className="bg-white rounded-2xl p-8 max-w-md w-full shadow-2xl"
            >
                <h3 className="text-2xl font-bold text-gray-900 mb-6">Create New Node</h3>
